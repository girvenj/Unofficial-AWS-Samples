...
module "managed_ad" {
  ...
  mad_secret_kms_key                       = var.mad_secret_kms_key
...
module "fsx_mad" {
  ...
  fsx_mad_kms_key                         = var.fsx_mad_kms_key
...
module "onprem_root_instance" {
  ...
  onprem_root_dc_ebs_kms_key              = var.onprem_root_dc_ebs_kms_key
  ...
  onprem_root_dc_secret_kms_key           = var.onprem_root_dc_secret_kms_key
  onprem_root_dc_security_group_ids       = module.ad_security_group_primary.sg_id
...
module "mad_mgmt_instance" {
  ...
  mad_mgmt_ebs_kms_key        = var.mad_mgmt_ebs_kms_key
  mad_mgmt_random_string      = random_string.random_string.result
  mad_mgmt_security_group_ids = module.ms_security_group_primary.sg_id
...
module "fsx_onpremises" {
  ...
  fsx_self_kms_key                          = var.fsx_self_kms_key
...
module "onprem_pki_instance" {
  ...
  onprem_pki_ebs_kms_key        = var.onprem_pki_ebs_kms_key
  onprem_pki_random_string      = random_string.random_string.result
  onprem_pki_security_group_ids = module.pki_security_group_primary.sg_id
...
module "onprem_child_dc_instance" {
  ...
  onprem_domain_fqdn                 = module.onprem_root_instance.onprem_ad_domain_name
  onprem_child_dc_ebs_kms_key        = var.onprem_child_dc_ebs_kms_key
  onprem_child_dc_random_string      = random_string.random_string.result
  onprem_child_dc_security_group_ids = module.ad_security_group_primary.sg_id
...
module "onprem_additional_dc_instance" {
  ...
  onprem_domain_fqdn                      = module.onprem_root_instance.onprem_ad_domain_name
  onprem_domain_netbios                   = module.onprem_root_instance.onprem_ad_netbios_name
  onprem_additional_dc_ebs_kms_key        = var.onprem_additional_dc_ebs_kms_key
  onprem_additional_dc_random_string      = random_string.random_string.result
  onprem_additional_dc_security_group_ids = module.ad_security_group_primary.sg_id
