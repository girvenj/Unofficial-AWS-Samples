...
variable "onprem_additional_dc_ec2_ami_name" {
  description = "Name of the AMI that was provided during image creation."
  type        = string
}

variable "onprem_additional_dc_ec2_ami_owner" {
...
variable "onprem_additional_dc_use_customer_managed_key" {
  description = "Use Customer Managed KMS Keys (CMK) for encryption"
  type        = bool
}
